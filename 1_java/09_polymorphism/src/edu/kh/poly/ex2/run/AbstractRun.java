...
import edu.kh.poly.ex2.model.service.JTJCalculator;
import edu.kh.poly.ex2.model.service.YDGCalculator;
...
//		service.ex1();
//		service.ex2();
		Calculator cal = new JTJCalculator();
//		Calculator ca1 = new YDGCalculator();
	
		
		
		//Calculator cal = new Calculator();
		// 인터페이스 == 미완성 설계도 == 객체 생성 불가능
		// -> 추상 클래스 처럼 참조 변수로는 사용 가능
