...
public class InterruptTest {
	 ...
	 *		interrupt()를 호출하게 되면
	 *		스레드의 interrupted 필드 값이 true로 변하지 않고(작업 종료X)
	 *		InterruptedException이 발생함
	 *
	 *
	 * boolean isInterrupted()
	 *	- 현재 스레드의 interrupted 필드 값을 반환 (getter)
	 * 
	 * boolean Thread.interrupted()
	 * 	- 현재 스레드의 interrupted 필드 값을 반환
	 * 	+ false로 값을 변경
	 * */
	...
	public void test() {
		...
		sleep2.start(); // SleepThread2의 run() 메소드 실행
