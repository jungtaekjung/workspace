...
public class ExceptionService {
	...
	public void ex1() {
		...
		try {
			...
			// try에서 던져진 예외를 catch문의 매개변수로 잡음
	...
	public void methodD() {
		...
		// --> 예외처리 구문이 아니라 if문과 같은 단순 코드로도 해결이 가능
