...
CREATE TABLE MEMBER(
		...
		MEMBER_SSN CHAR(14), -- 123456-1234567
...
-- 만든 테이블 확인
	SELECT * FROM MEMBER;
	SELECT * FROM USER_TABLES; -- 딕셔너리 뷰(데이터 딕셔너리에서 일부분만 뽑아서 만든 가상 케이블)
...
-- 추가 샘플 데이터 삽입
--> 가입일 SYSDATE 활용
INSERT INTO MEMBER VALUES('MEM02', 'PASS02', '멤버이','951126-2234567', SYSDATE);

--> 가입일 미작성 시 -> DEFAULT 값이 반영됨
INSERT INTO MEMBER(MEMBER_ID,MEMBER_PWD,MEMBER_NAME,MEMBER_SSN) VALUES('MEM03','PASS03','멤버삼','971126-1231234');
...
-- 주민등록번호의 데이터 작업을 NUMBER로 지정할 경우 문제점
INSERT INTO MEMBER2 VALUES('홍길동',991126-1234567);
INSERT INTO MEMBER2 VALUES('김철수',001226-1234567);
INSERT INTO MEMBER2 VALUES('이영희',0012262334567);
INSERT INTO MEMBER2 VALUES('이나라',9012262334567);
...
-- 삽입/수정 시 NULL값을 허용되지 않게 컬럼레벨에서 제한

CREATE TABLE USER_USED_NN(
	USER_NO  NUMBER NOT NULL, -- 사용자 번호 (무조건 존재해야 함 == NULL X!)
	USER_ID  VARCHAR2(20),
...
VALUES(1,'user01','pass01','유저일','M','010-1234-5678','user01@kh.or.kr');

INSERT INTO USER_USED_NN
VALUES(NULL,NULL,NULL,'유저일','M','010-1234-5678','user01@kh.or.kr');
-- SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH_JTJ"."USER_USED_NN"."USER_NO") 안에 삽입할 수 없습니다
...
-- + UNIQUE 제약조건이 설정된 컬럼에 NULL 값은 중복 삽입 가능
...
INSERT INTO USER_USED_UK
VALUES(2,'user01','pass01','유저일','M','010-1234-5678','user01@kh.or.kr');
--> 같은 아이디인 데이터가 이미 테이블에 있으므로 UNIQUE 제약 조건에 위배되어 오류 발생

INSERT INTO USER_USED_UK
VALUES(2,NULL,'pass01','유저일','M','010-1234-5678','user01@kh.or.kr');
--> 아이디에 NULL 값 삽입 가능
INSERT INTO USER_USED_UK
VALUES(3,NULL,'pass01','유저일','M','010-1234-5678','user01@kh.or.kr');
...
INSERT INTO USER_USED_UK2
VALUES(1,'user02','pass01','유저일','M','010-1234-5678','user01@kh.or.kr');
--> USER_ID만 다름 --> 삽입 성공

INSERT INTO USER_USED_UK2
VALUES(1,'user01','pass01','유저일일','M','010-1234-5678','user01@kh.or.kr');
--> USER_NAME만 다름 --> 삽입 성공

INSERT INTO USER_USED_UK2
VALUES(2,'user01','pass02','유저일','F','010-1234-5678','user01@kh.or.kr');
-- ORA-00001: 무결성 제약 조건(KH_JTJ.USER_ID_NAME_U)에 위배됩니다
...
INSERT INTO USER_USED_PK
VALUES(1,'user02','pass02','유저이','F','010-1234-5678','user01@kh.or.kr');
-- 무결성 제약 조건(KH_JTJ.USER_NO_PK)에 위배됩니다 == UNIQUE 오류와 같음
--> 기본키 중복으로 오류

INSERT INTO USER_USED_PK
VALUES(NULL,'user01','pass01','유저일','M','010-1234-5678','user01@kh.or.kr');
--  ORA-01400: NULL을 ("KH_JTJ"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다 
--> == NOT NULL 오류와 같음
--> 기본키가 NULL 이므로 오류
...
CREATE TABLE USER_USED_PK2(
	...
	CONSTRAINT USERNO_USERID_PK PRIMARY KEY(USER_NO,USER_ID) -- 테이블 레벨 PK 지정
...
INSERT INTO USER_USED_PK2
VALUES(1,'user01','pass02','유저이','M','010-1234-5678','user01@kh.or.kr');
--  ORA-00001: 무결성 제약 조건(KH_JTJ.USERNO_USERID_PK)에 위배됩니다
-- 회원 번호와 아이디 둘다 중복일 때만 제약조건 위배 에러 발생

INSERT INTO USER_USED_PK2
VALUES(NULL,'user03','pass02','유저이','M','010-1234-5678','user01@kh.or.kr');
-- ORA-01400: NULL을 ("KH_JTJ"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다
--> 복합키여도 PK(NOT NULL + UNIQUE )이므올
-- NULL 절대 삽입 불가!!
...
CREATE TABLE USER_USED_FK(
	...
	PHONE VARCHAR2(30),
	EMAIL VARCHAR2(50),
	GRADE_CODE NUMBER, -- CONSTRAINT GRADE_CODE_FK REFERENCES USER_GRADE(GRADE_CODE) -- 컬럼 레벨 FK

	CONSTRAINT GRADE_CODE_FK FOREIGN KEY(GRADE_CODE) REFERENCES USER_GRADE
																				--> 참조 테이블 컬럼명 생략 시 자동으로 PK 참조
	
	);
DROP TABLE USER_USED_FK;

INSERT INTO USER_USED_FK
VALUES(1,'user01','pass01','유저일','M','010-1234-5678','user01@kh.or.kr',10);

INSERT INTO USER_USED_FK
VALUES(2,'user02','pass01','유저일','M','010-1234-5678','user01@kh.or.kr',20);

INSERT INTO USER_USED_FK
VALUES(3,'user03','pass01','유저일','M','010-1234-5678','user01@kh.or.kr',NULL);
--> NULL 사용 가능

INSERT INTO USER_USED_FK
VALUES(4,'user01','pass01','유저일','M','010-1234-5678','user01@kh.or.kr',40);
-- ORA-00001: 무결성 제약 조건(KH_JTJ.SYS_C007491)에 위배됩니다
--> 참조 무결성 위배


-- 40이라는 값은 USER_GRADE 테이블의 GRADE_CODE 컬럼에서 제공하는 값이 아니므로
...
SELECT*FROM USER_GRADE;   -- 참조를 당하는 테이블 == 부모테이블
SELECT*FROM USER_USED_FK; -- 참조를 하는 테이블 == 자식 테이블
  
DELETE FROM USER_GRADE
WHERE GRADE_CODE = 30;
-- ORA-02292: 무결성 제약조건(KH_JTJ.GRADE_CODE_FK)이 위배되었습니다- 자식 레코드가 발견되었습니다
...
INSERT INTO USER_USED_FK2
VALUES(2,'user02','pass02','유저일','M','010-1234-5678','user01@kh.or.kr',10);

INSERT INTO USER_USED_FK2
VALUES(3,'user03','pass03','유저일','M','010-1234-5678','user01@kh.or.kr',30);

INSERT INTO USER_USED_FK2
VALUES(4,'user04','pass04','유저일','M','010-1234-5678','user01@kh.or.kr',NULL);
...
-- 2) ON DELETE SET CASCADE : 부모키 삭제 시 자식키도 함께 삭제됨
...
-- 부모 테이블인 USER_GRADE3 에서 GRADE_CODE = 30 삭제
DELETE FROM USER_GRADE3 WHERE GRADE_CODE=30;
SELECT * FROM USER_GRADE3; -- 부모 테이블 삭제 확인 (10 없음)
...
CREATE TABLE USER_USED_CHECK(
	...
	USER_PWD  VARCHAR2(30) ,
	USER_NAME  VARCHAR2(30),
	GENDER VARCHAR2(1) CONSTRAINT GENDER_CHECK CHECK(GENDER IN('F','M') ),
	PHONE VARCHAR2(30),
	EMAIL VARCHAR2(50)
);
...
INSERT INTO USER_USED_CHECK
VALUES(2,'user02','pass02','유저일','H','010-1234-5678','user01@kh.or.kr');
-- ORA-02290: 체크 제약조건(KH_JTJ.GENDER_CHECK)이 위배되었습니다

-- GENDER 컬럼에 CHECK 제약 조건으로 'F' 또는 'M'만 기록 가능하게 함
-- 해당 값 이외에 값이 들어와서 에러 발생
...
INSERT INTO USER_TEST (USER_NO, USER_ID, USER_PWD, PNO, GENDER, PHONE, ADDRESS, STATUS, AGE)
VALUES (1, 'user01', 'pwd01242', '123123-1234561', '남', '010-1234-5678', '서울시 강남구', 'Y', 25);

INSERT INTO USER_TEST (USER_NO, USER_ID, USER_PWD, PNO, GENDER, PHONE, ADDRESS, STATUS, AGE)
VALUES (2, 'user02', 'pwd02242', '123122-2223451', '여', '010-2345-6789', '서울시 종로구', 'N', 30);

INSERT INTO USER_TEST (USER_NO, USER_ID, USER_PWD, PNO, GENDER, PHONE, ADDRESS, STATUS, AGE)
VALUES (3, 'user03', 'pwd03242', '321123-1212121', '남', '010-3456-7890', '서울시 서초구', 'Y', 45);

INSERT INTO USER_TEST (USER_NO, USER_ID, USER_PWD, PNO, GENDER, PHONE, ADDRESS, STATUS, AGE)
VALUES (4, 'user04', 'pwd04242', '321122-2112121','여', '010-4567-8901', '서울시 송파구', 'N', 28);

INSERT INTO USER_TEST (USER_NO, USER_ID, USER_PWD, PNO, GENDER, PHONE, ADDRESS, STATUS, AGE)
VALUES (5, 'user05', 'pwd05242', '322112-1122112', '남', '010-5678-9012', '서울시 은평구', 'Y', 35);
...
-- 컬럼명, 데이터 타입, 값 복사되고 제약조건은 NOT NULL만 복사 됨
...
-- EMP_ID 컬럼에 PRIMARY KEY 제약 조건 추가
